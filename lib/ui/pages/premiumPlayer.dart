...
class PremiumPlayer extends StatefulWidget {
  const PremiumPlayer({Key? key}) : super(key: key);

  @override
  _PremiumPlayerState createState() => _PremiumPlayerState();
}
...
class _PremiumPlayerState extends State<PremiumPlayer> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback(
        (_) => Get.find<PlayerListController>().searchPlayerlist(1));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PlayerListController>(
      builder: (_searchByService) => _searchByService
                  .playerListDisplay.length !=
              0
          ? Container(
              height: 180.h,
              width: 260.w,
