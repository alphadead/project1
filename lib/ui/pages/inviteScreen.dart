          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          AppLocalizations.of(context)!.invitePage_rewardInfo,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: .3.sw,
                        child: Text(
                          AppLocalizations.of(context)!.invitePage_getRewarded,
                          style: themeData().textTheme.headline2!.copyWith(
                              color: KColorBlack, fontWeight: FontWeight.w400),
                          textAlign: TextAlign.center,
                        ),
              ...
              Container(
                ...
                child: Text(
                  AppLocalizations.of(context)!.invitePage_yourReferralCode,
                  style: themeData()
                      .textTheme
                      .headline1!
              ...
              GestureDetector(
                onTap: () {
                  Utility.showError(
                      AppLocalizations.of(context)!.invitePage_textCopied);
